            ...
            {showSuccess && internalMode === "signup" ? (
              <div className="text-center py-8">
                ...
                <a
                  ...
                  onClick={() => {
                    // Store auth so dashboard can pick it up
                    if (window.__pendingAuth) {
                      login(window.__pendingAuth.token, window.__pendingAuth.user);
                      delete window.__pendingAuth;
                    }
                  }}
                  className="flex items-center justify-center gap-2 w-full h-12 rounded-full text-white font-semibold mb-3"
                ...
                <button
                  ...
                  className="w-full h-10 rounded-full text-gray-500 text-sm font-medium border border-gray-200 hover:bg-gray-50"
                >
