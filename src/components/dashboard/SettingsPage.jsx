...
const SettingsPage = ({ darkMode }) => {
 ...
 : (darkMode ?"hover:bg-white/5" :"hover:bg-gray-50")
                ...
                >
                  ...
                  />
                  <span className={`text-[13.5px] whitespace-nowrap ${isActive ? (darkMode ?"font-semibold text-white" :"font-semibold text-gray-900") : (darkMode ?"font-medium text-white/60" :"font-medium text-gray-500")}`}>
                    {section.label}
                  </span>
                </button>
              );
