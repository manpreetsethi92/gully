      ...
      <main className="pt-24 pb-16 px-6">
        <div className="max-w-4xl mx-auto prose prose-gray">
          ...
          <section className="mb-8">
            ...
            <p>Welcome to Giggy ("Platform," "Service," "we," "our," or "us"), operated by Made of Drama Studios Inc., a Texas corporation with its principal place of business in Dallas, Texas. By accessing or using our website (getgiggy.ai), WhatsApp bot, voice services, mobile applications, or any related services (collectively, "Services"), you agree to be bound by these Terms of Service ("Terms").</p>
          ...
          <section className="mb-8">
            ...
            <p>Giggy is a creative professional networking platform that connects freelancers and creative professionals through an AI-powered matching system. Our Services include:</p>
          ...
          <section className="mb-8">
            ...
            <p>Giggy acts as a facilitator connecting creative professionals. We are not a party to any agreements between users and do not guarantee the quality, safety, or legality of services offered by users.</p>

            <h3 className="text-xl font-medium mb-3">6.2 No Verification Guarantee</h3>
            <p><strong>We do not routinely verify user identities, backgrounds, licenses, portfolios, credentials, or references.</strong> While we may implement certain verification features, users are solely responsible for conducting their own vetting, background checks, and due diligence before hiring or working with any professional found through Giggy. Any "verified" badges or trust scores are internal indicators based on platform activity and should not be considered a comprehensive background check or endorsement.</p>

            <h3 className="text-xl font-medium mb-3">6.3 External Opportunities</h3>
            <p>Some job postings and opportunities displayed on Giggy are sourced or aggregated from third-party platforms including but not limited to Reddit, X (Twitter), Craigslist, and Facebook. For these external opportunities:</p>
            <ul className="list-disc pl-6 mb-4">
            ...
            <p>Giggy does not create any employment, agency, partnership, or joint venture relationship between users or between users and Giggy.</p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p>You may request human review of significant AI-driven decisions affecting your account by contacting support@getgiggy.ai.</p>
          </section>

          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4">8. Changes to Services</h2>
            <p>We are continuously improving Giggy and may modify the Services at any time:</p>
            <ul className="list-disc pl-6 mb-4">
          ...
          <section className="mb-8">
            ...
            <p>Currently, basic Giggy Services are provided free of charge. We reserve the right to introduce paid features or subscription plans in the future, with reasonable notice to users.</p>
            <p>Any payments between users for services are handled directly between those parties. Giggy is not responsible for payment disputes between users.</p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p>You may terminate your account at any time by contacting us at support@getgiggy.ai or through your account settings.</p>
          ...
          <section className="mb-8">
            ...
            <p>We may provide notices to you via email, WhatsApp, or through the Services. You may provide notices to us at legal@getgiggy.ai.</p>
          </section>
          ...
          <section className="mb-8">
            ...
            United States</p>
            <p>General Support: <a href="mailto:support@getgiggy.ai" className="text-red-600 hover:underline">support@getgiggy.ai</a><br />
            Legal Inquiries: <a href="mailto:legal@getgiggy.ai" className="text-red-600 hover:underline">legal@getgiggy.ai</a><br />
