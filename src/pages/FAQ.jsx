  ...
  const faqs = [
    {
      ...
      questions: [
        ...
        {
          q: "How is Gully different from Upwork or LinkedIn?",
        ...
        {
          q: "What categories does Gully cover?",
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          a: "Text Taj at +1 213-414-7369 on WhatsApp and say \"I need help\", or email taj@trygully.com. We're a small team and we actually respond."
        }
      ]
    }
  ];
    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-sm border-b border-gray-100">
        <nav className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <a href="/" className="flex items-center gap-3">
            <span className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-black"><span style={{fontFamily:"Georgia,serif",fontSize:"16px",fontWeight:"400",color:"white",lineHeight:1}}>G</span></span>
      ...
      <main className="pt-24 pb-16 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-gray-500 mb-12">Everything you need to know about Gully</p>
