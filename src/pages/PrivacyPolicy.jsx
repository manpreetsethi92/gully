      ...
      <main className="pt-24 pb-16 px-6">
        <div className="max-w-4xl mx-auto prose prose-gray">
          ...
          <section className="mb-8">
            ...
            <p>Contact privacy@getgiggy.ai with subject "Passive Profile Request" to exercise these rights.</p>
          ...
          <section className="mb-8">
            ...
            <p>You may request information about automated decision-making logic and request human review of certain decisions. Contact privacy@getgiggy.ai.</p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p>If you believe your trust score or any related decision is incorrect, you may contact support@getgiggy.ai to understand the decision and request review. We will investigate and correct any errors.</p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p>Access and update your information through account settings, our WhatsApp bot, or by contacting privacy@getgiggy.ai.</p>

            <h3 className="text-xl font-medium mb-3">10.2 Account Deletion</h3>
            <p>Request deletion at support@getgiggy.ai. We process requests within 30 days, except where retention is legally required or necessary for platform safety.</p>
            ...
            <p>Request a copy of your data in machine-readable format at privacy@getgiggy.ai.</p>
          ...
          <section className="mb-8">
            ...
            <p>We do NOT sell personal information. You may opt out of sharing for cross-context behavioral advertising by emailing privacy@getgiggy.ai with subject "Opt-Out of Sharing."</p>

            <h3 className="text-xl font-medium mb-3">11.5 Right to Limit Use of Sensitive Personal Information</h3>
            <p>You may limit our use of sensitive personal information to only what is necessary to provide the Services. Email privacy@getgiggy.ai with subject "Limit Sensitive Information."</p>
            ...
            <p>Submit requests to privacy@getgiggy.ai with subject "California Privacy Request." We will verify your identity using information associated with your account. We respond within 45 days (may be extended by 45 days with notice).</p>
            ...
            <p>California residents may request information about disclosure of personal information to third parties for direct marketing. We do not share personal information with third parties for their direct marketing purposes. Contact privacy@getgiggy.ai for more information.</p>
          </section>

          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4">12. Other State Privacy Rights</h2>
            <p>Residents of Virginia, Colorado, Connecticut, Utah, and other states with comprehensive privacy laws may have similar rights to access, delete, correct, and opt-out. Contact privacy@getgiggy.ai to exercise these rights.</p>
          </section>

          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4">13. International Users</h2>
            <p>Giggy is operated from the United States (Dallas, Texas). If you are outside the U.S., your information may be transferred to and processed in the United States.</p>
          ...
          <section className="mb-8">
            ...
            <p>Our Services are not for individuals under 18. We do not knowingly collect personal information from children under 18. If we learn we have collected such information, we will delete it promptly. Contact privacy@getgiggy.ai if you believe we have inadvertently collected information from a child.</p>
          </section>
          ...
          <section className="mb-8">
            ...
            United States</p>
            <p>Privacy Inquiries: <a href="mailto:privacy@getgiggy.ai" className="text-red-600 hover:underline">privacy@getgiggy.ai</a><br />
            General Support: <a href="mailto:support@getgiggy.ai" className="text-red-600 hover:underline">support@getgiggy.ai</a><br />
            WhatsApp: <a href="https://wa.me/12134147369" className="text-red-600 hover:underline">+1 (213) 414-7369</a><br />
            Website: <a href="https://getgiggy.ai" className="text-red-600 hover:underline">https://getgiggy.ai</a></p>
            <p>For data access, deletion, correction, or other privacy requests:<br />
            Email: privacy@getgiggy.ai<br />
